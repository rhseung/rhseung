...
export const I18N_NAMESPACES = ['common', 'about', 'blog', 'home', 'projects'] as const;
...
void i18next.use(initReactI18next).init({
  resources: {
    ko: { common: commonKo, about: aboutKo, blog: blogKo, home: homeKo, projects: projectsKo },
    en: { common: commonEn, about: aboutEn, blog: blogEn, home: homeEn, projects: projectsEn },
  },
