...
export default defineCareer({
  ...
  ko: {
    ...
    achievements: [
      '정보 부문 GPA 4.285 / 4.3',
      '교내경시대회 정보 부문 금상 2회 (2022, 2023), 2022년은 1학년 중 유일',
      '정보 교과우수상 6회, 그중 4회 1위',
    ],
  },
  en: {
    ...
    achievements: [
      ...
      'Gold Prize twice in the in-school computer science competition (2022, 2023), the 2022 one was the only award given to a first-year student',
