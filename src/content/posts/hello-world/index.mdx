...
| ------ | ----------------------------------------- | -------------- | -------------- | --------- | ---- | --- | --- | ---- |
| 팔레트 | <Shortcut keys={['cmd', 'shift', 'p']} /> | `Ctrl+Shift+P` | `Ctrl+Shift+P` | 전부 같다 | a    | b   | c   | d    |
| 저장   | <Shortcut keys={['cmd', 's']} />          | `Ctrl+S`       | `Ctrl+S`       | 습관      | e    | f   | g   | h    |
